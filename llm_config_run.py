...
def get_llm_selection_widget(
    languages=list(SUPPORTED_LLM_MODELS), models=SUPPORTED_LLM_MODELS[default_language], show_preconverted_checkbox=False, device=None, default_model_idx=-3
):
    import ipywidgets as widgets

    lang_dropdown = widgets.Dropdown(options=languages or [], value=languages[-1])
